...
from utils.datasets import LoadStreams, LoadImages, LoadCamera
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-dir', default='/home/siplab/桌面/yoloNhit_calvin/HIT/data/table_tennis', help='save results directory')
